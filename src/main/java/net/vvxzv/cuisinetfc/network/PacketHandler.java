...
public final class PacketHandler {
    public static <T extends CustomPacketPayload> CustomPacketPayload.Type<T> type(String id) {
        return new CustomPacketPayload.Type<>(ResourceLocation.fromNamespaceAndPath(CuisineTFC.MODID, id));
    }

    public static void setup(RegisterPayloadHandlersEvent event) {
        PayloadRegistrar register = event.registrar(ModList.get().getModFileById(CuisineTFC.MODID).versionString());
